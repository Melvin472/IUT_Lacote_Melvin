...
//Waypoint_t waypoints[MAX_POS] = {{1, 0, 0}, {1, 0.5, 0}, {2.0, 0.5, 0}, {2.0, -0.5, 0}, {1, -0.5, 0}, {1, 0, 0}, {1.5, 0, 0}};
Waypoint_t waypoints[MAX_POS] = {{0.1, 0, 0}, {0.1, 0.1, 0}, {0.2, 0.1, 0}, {0.2, -0.1, 0}, {0.1, -0.1, 0}, {0.1, 0, 0}, {0.15, 0, 0}};
